# -*- coding: utf-8 -*-
"""
Created on Tue Dec  1 21:04:04 2020
...
for l in input.split('\n'):
    l = l.strip()
    r = re.match(r'(\d+)\-(\d+) (\w): (\w+)', l)
    if r is not None:
        a1, a2, let, pwd = r.groups()
        i1 = int(a1); i2 = int(a2)
        if pwd.count(let) >= i1 and pwd.count(let) <= i2:
            ct += 1
print(ct)
